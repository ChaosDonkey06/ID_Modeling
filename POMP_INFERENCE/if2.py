##
##  R code to generate Figures 1 and 2 of 
##  "Inference for dynamic and latent variable models 
##        via iterated, perturbed Bayes maps"
...
matplot(k1x[,1:8],k1y[,1:8],lty=1,type='l',main="",axes=F,xlab='',ylab='')
